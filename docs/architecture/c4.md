...
C4Component
    ...
    Container_Boundary(web, "board-web") {
        ...
        Component(api, "api/", "Axios 客户端", "records / patches / recordHead / history / snapshots / exports / boardCurrent / config / profiles / agentDrafts / agentSuggestions / agentSkills")
    }
