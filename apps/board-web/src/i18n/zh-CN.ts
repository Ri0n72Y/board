const zhCN = {
  translation: {
    ...
    'create.descriptionPlaceholder': '简短描述',
    'create.content': '内容',
    'create.contentPlaceholder': '记录内容',
    'create.statusTag': '状态标签',
    'create.statusTagPlaceholder': 'status:todo',
    'create.priorityTag': '优先级标签',
    ...
    'edit.description': '描述',
    'edit.descriptionPlaceholder': '简短描述',
    'edit.content': '内容',
    'edit.contentPlaceholder': '记录内容',
    'edit.statusTag': '状态标签',
    'edit.statusTagPlaceholder': 'status:todo',
    'edit.priorityTag': '优先级标签',
    'edit.priorityTagPlaceholder': 'priority:medium',
    'edit.otherTags': '其他标签',
    'edit.otherTagsPlaceholder': 'custom:tag\narea:ui',
    'edit.otherTagsHint': '每行一个标签。状态和优先级标签在上面管理。',
    'edit.assignee': '负责人',
    'edit.assets': '资产',
