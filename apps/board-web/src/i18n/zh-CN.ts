const zhCN = {
  translation: {
    ...
    'settings.membersHint': '管理团队成员资料与头像。',
    'settings.manageMembers': '管理成员',
    ...
    'filters.assigneePlaceholder': '按成员名称搜索',
    'filters.allAssignees': '所有成员',
    'filters.includeArchived': '包含已归档',
    'filters.assetId': '资产 ID',
    'filters.assetIdPlaceholder': '搜索资产',
    'filters.assetSelector': '资产筛选',
    'filters.relationTarget': '关联目标',
    'filters.relationTargetPlaceholder': '搜索关联目标',
    'filters.relationTargetSelector': '关联目标筛选',
    'filters.noAssetOptions': '无可选资产',
    'filters.noRelationTargetOptions': '无可选关联目标',
    ...
    'recordReference.unknownAsset': '未知资产',
    'recordReference.unknownRecord': '未知记录',
    'recordReference.rawId': '原始 ID',
    'relations.title': '关联',
    'relations.add': '添加关联',
    'relations.remove': '删除关联',
    'relations.constraint': '关系',
    'relations.target': '目标',
    'relations.description': '说明',
    ...
    'relations.constraint.blocks': '阻塞',
    'relations.constraint.blockedBy': '被阻塞',
    'relations.constraint.relatedTo': '关联',
    'relations.constraint.relatesTo': '关联',
    'relations.constraint.duplicates': '重复',
    'relations.constraint.duplicate': '重复',
    'relations.constraint.parentOf': '父项',
    'relations.constraint.childOf': '子项',
    'relations.constraint.contains': '包含',
    'relations.constraint.supports': '支持',
    'relations.constraint.implementedBy': '实现方',
    'relations.constraint.asset:completion-of': '完成对象',
    'relations.constraint.progress:contributes-to': '贡献到',
    ...
    'agent.suggestions.emptyMarkdown': '暂无 Markdown 内容。',
    ...
    'agent.suggestions.audit': '审计元数据',
    'agent.suggestions.auditProvider': 'Provider',
    'agent.suggestions.auditGeneratedAt': '生成时间',
    'agent.suggestions.auditContextChars': '上下文字数',
    'agent.suggestions.auditSkillChars': 'Skill 字数',
    'agent.suggestions.auditInstructionChars': '指令字数',
    'agent.suggestions.auditEstimatedInputTokens': '输入 token 估算',
    'agent.suggestions.auditEstimatedOutputTokens': '输出 token 估算',
    'agent.suggestions.auditLimits': '上限',
    'agent.suggestions.auditTokenLimits': 'Token 上限',
    'agent.suggestions.auditBudget': '预算检查',
    'agent.suggestions.auditValidation': '输出校验',
    'agent.suggestions.auditRealProvider': '真实 provider',
    'agent.suggestions.auditContextHash': '上下文哈希',
    'agent.suggestions.auditUnknown': '未知',
    'agent.suggestions.yes': '是',
    'agent.suggestions.no': '否',
    ...
    'history.statusIncomplete': '重放未完成。请先检查诊断信息。',
    'history.patches': '修改记录',
    'history.noPatches': '此记录暂无修改。',
    'history.finalState': '最终状态',
    'history.edit': '编辑',
    'history.editTitle': '编辑记录',
    'history.close': '关闭',
    'history.changeCount': '{{count}} 次修改',
    'history.initialRecord': '初始记录',
    'history.createdMeta': '创建于 {{date}} · {{actor}}',
    'history.debugInfo': '调试信息',
    'history.rawPatch': '查看原始 patch',
    'history.assetListEmpty': '无资产',
    'history.diagnostics': '诊断信息',
    'history.references': '引用',
    'history.summarySeparator': '：',
    'history.noVisibleChanges': '无可见字段修改',
    'history.none': '无',
    'history.unassigned': '未分配',
    'history.modified': '已修改',
    'history.itemCount': '{{count}} 项',
    'history.tagAdded': '新增标签',
    'history.tagRemoved': '删除标签',
    'history.field.status': '状态',
    'history.field.priority': '优先级',
    'history.field.epic': 'Epic',
    'history.field.sprint': 'Sprint',
    'history.field.owner': '负责方',
    'history.field.type': '类型',
    'history.field.milestone': '里程碑',
    'history.field.assignee': '负责人',
    'history.field.body': '正文',
    'history.field.assets': '资产',
    'history.field.relations': '关联',
    'history.bodyField.title': '标题',
    'history.bodyField.description': '摘要',
    'history.bodyField.content': '详细内容',
    'history.status.empty': '无修改',
    'history.status.complete': '完成',
    'history.status.broken': '中断',
    'history.status.conflicted': '冲突',
    'history.relation.dependsOn': '依赖',
    'history.relation.blocks': '阻塞',
    'history.relation.blockedBy': '被阻塞',
    'history.relation.relatedTo': '关联',
    'history.relation.relatesTo': '关联',
    'history.relation.duplicates': '重复',
    'history.relation.duplicate': '重复',
    'history.relation.parentOf': '父项',
    'history.relation.childOf': '子项',
    'history.relation.contains': '包含',
    'history.relation.supports': '支持',
    'history.relation.implementedBy': '实现方',
    'history.relation.asset:completion-of': '完成对象',
    'history.relation.progress:contributes-to': '贡献到',
    ...
    'profileManager.copied': '已复制！',
    'profileManager.loading': '正在加载成员…',
    'profileManager.empty': '暂无成员。创建一个来分配记录。',
    'profileManager.noResults': '没有匹配的成员。',
    'profileManager.createTitle': '创建成员',
    'profileManager.editTitle': '编辑成员',
    'profileManager.pk': '公钥',
    'profileManager.pkPlaceholder': '成员的公钥',
    'profileManager.name': '显示名称',
    'profileManager.namePlaceholder': '例如：Ada Lovelace',
    'profileManager.avatarUrl': '头像 URL（可选）',
    'profileManager.avatarUrlPlaceholder': 'https://example.com/avatar.png',
    'profileManager.cancel': '取消',
    'profileManager.saving': '保存中…',
    'profileManager.createButton': '创建成员',
    'profileManager.saveButton': '保存修改',
    'profileManager.errorPkRequired': '公钥为必填项。',
    'profileManager.errorNameRequired': '显示名称为必填项。',
    'profileManager.errorGeneral': '发生错误，请重试。',
  },
}
