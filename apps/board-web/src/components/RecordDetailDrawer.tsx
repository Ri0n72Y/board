      ...
      <div className="grid w-full max-w-md gap-4 rounded-xl border border-slate-200 bg-white p-5 shadow-xl">
        ...
        <label className="grid gap-1.5">
          ...
          <textarea
            ...
            className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-950 outline-none transition-colors focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200"
