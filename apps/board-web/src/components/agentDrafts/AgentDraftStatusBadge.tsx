...
export function AgentDraftStatusBadge({
  status,
}: {
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded px-1.5 py-0.5 text-xs font-semibold uppercase ${colors[status]}`}
    >
