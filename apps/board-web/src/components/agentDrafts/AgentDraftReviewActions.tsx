...
export function AgentDraftReviewActions({
  ...
  // Sync local note when draft changes
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional sync on key change, parent also uses key={draft.id}
